...
function getImageUrl(name) {
 //return new URL(`../assets/${bar.image}`, import.meta.url).href
 return new URL(`../assets/${name.image}`, import.meta.url).href
 }
          ...
          barList: [
            {
              ...
              ganttBarConfig: {id : "test002", color:"white", backgroundColor: "#de3b26", bundle:"redBundle"}
            },
            {
              myStart: "2020-03-03 04:00",
              myEnd: "2020-03-03 15:00",
              label: "We belong together ^",
              ganttBarConfig: {id : "test003", color:"white", backgroundColor: "#2e74a3", bundle:"blueBundle"}
            },
            {
              myStart: "2020-03-03 18:00",
              myEnd: "2020-03-03 22:00",
              label: "Bar",
              ganttBarConfig: {id : "test004", color:"white", backgroundColor: "#aa34a3"}
            }
          ]
        },
          ...
          barList: [
            {
              ...
              ganttBarConfig: {id : "test031", color:"white", backgroundColor: "#de3b26", bundle: "redBundle"}
            },
            {
              myStart: "2020-03-02 22:30",
              myEnd: "2020-03-03 05:00",
              label: "With handles!",
              ganttBarConfig: {id : "test032", color:"white", backgroundColor: "#a23def", handles: true}
            },
            {
              myStart: "2020-03-02 01:00",
              myEnd: "2020-03-02 07:00",
              label: "Bar",
              ganttBarConfig: {id : "test033", color:"white", backgroundColor: "#5effad"}
            },
            {
              myStart: "2020-03-03 14:00",
              myEnd: "2020-03-03 20:00",
              label: "Woooow!",
              ganttBarConfig: {id : "test034", color:"white", background: "repeating-linear-gradient(45deg,#de7359,#de7359 10px,#ffc803 10px,#ffc803 20px)"}
            }, 
          ]
        },
          ...
          barList: [
            {
              ...
              myEnd: "2020-03-03 20:00",
              label: "Bar",
              ganttBarConfig:{id : "test41", color:"white", backgroundColor: "#d18aaf", handles: true}
            },
            {
              myStart: "2020-03-02 00:30",
              myEnd: "2020-03-03 01:00",
              label: "Rectangular",
              ganttBarConfig: {id : "test42", color:"white", backgroundColor: "#f2840f", borderRadius: 0}
            }, 
          ]
        }
